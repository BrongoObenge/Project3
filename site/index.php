...
// other php code
    $re = '/#(\w+)\s#(\w+)\sis op (\d+-\d+)\s(\d+:\d+) (\w+)lijn /im';
    $str = '#OV #Vertraging #Alkmaar is op 04-08 16:20 Buslijn 2 + - 5 min. vertraging meer info: http://www.totalov.nl
    #OV #Controle #Rotterdam is op 04-08 20:02 Metrolijn D naar Beurs meer info: http://www.totalov.nl
    #OV #Controle #Utrecht is op 04-08 20:01 Tramlijn 61 Van en naar Nieuwegein Stadscentrum meer info: http://www.totalov.nl ';
